...
####  ####
  ...
  **07:00**|**개발 종료 및 최종 제출**|❌ 이 시간 이후로 본인의 서비스를 **더이상 개발할 수 없습니다.**
  ...
  + 최종 서비스
    ...
    |2|Personal|팀장|정여진, 정민경, 이은정, 주시현, 박진아, 이시현 (김재원, 신지애)|서비스명|서비스 URL|
    |3|ScentofaLion|팀장|이혜윤, 김예은, 김소정, 이동령, 신미리, 홍석민 (이준현, 송진서, 홍여진)|Mood Palette|https://62e45601c9d374073aac8d06--subtle-kitsune-42d48a.netlify.app/|
